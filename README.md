...
This repository contains the Shopify theme for the Techrus consumer electronics store. The current implementation extends the Horizon storefront with electronics-focused product metafields, a comparison widget, and conceptual Shopify Functions discount documentation.
